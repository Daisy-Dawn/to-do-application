...
export const Contact = () => {
  ...
  return (
    <>
    <div className="contact-wrapper bg-white px-6 py-24 sm:py-32 lg:px-8">
      <div
      ...
      <span className="briefcase"><FcBriefcase /></span>
        <h2 className="text-xl font-bold tracking-tight text-gray-900 sm:text-4xl">
         Contact Me for Your Full-Stack Web Applications</h2>
      </div>
      <form action="/" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2">
            <label htmlFor="company" className="block text-base font-semibold leading-6 text-gray-900">
              Address
            </label>
            <div className="mt-2.5">
              <input
